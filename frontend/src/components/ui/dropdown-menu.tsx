...
// Re-exported but unused here; kept so the primitive stays feature-complete.
...
export {
  ...
  DropdownMenuGroup,
  DropdownMenuPortal,
  // icons re-exported for parity with shadcn's file (sub-menus/checkboxes),
  // available if later menus need them.
